Shader "URP/Testddxddy1"
{
    Properties
    {
        ...
        [KeywordEnum(LMRTMB,CMRCMT,DDXDDY)]SampleType("Sample type",Float)=0
    ...
    SubShader
    {
		...
		Tags{
			...
			#pragma multi_compile SAMPLETYPE_LMRTMB SAMPLETYPE_CMRCMT SAMPLETYPE_DDXDDY
