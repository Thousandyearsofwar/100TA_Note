        ...
        + 降低纹理的频率：
          ...
          + Anisotropic Filtering 各向异性过滤方法：
            ...
            + Summed Area Table 积分图
              ...
              D3D:注意坐标原点为左上
              ![avatar](https://github.com/Thousandyearsofwar/100TA_Note/blob/main/Image/1.3Texture/SAT.png?raw=true)
              示例：
                  求(4,4)到(2,3)矩形区域
                  C=(28+5-8-17)/(3*2)=4/3=(1+2+1+0+2+2)/(3 *2)
                  注意：(1,2)为包围盒的左上角
              OpenGL:RTR4配图 注意坐标原点为左下
              ![avatar](https://github.com/Thousandyearsofwar/100TA_Note/blob/main/Image/1.3Texture/SAT1.png?raw=true)
              **<font size=5>
              $c=\frac{
