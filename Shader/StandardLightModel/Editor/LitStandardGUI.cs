...
namespace UnityEditor.Rendering.Universal.ShaderGUI
{
    ...
    "Select a workflow that fits your textures. Choose between Metallic or Specular.");
        ...
        public static void SetMaterialKeywords(Material material)
        {
            ...
            if (material.HasProperty("_ParallaxMode"))
            {
                ParallaxMode ParallaxModeType = (ParallaxMode)material.GetInt("_ParallaxMode");
                CoreUtils.SetKeyword(material, "_ParallaxMode_Off", ParallaxModeType == ParallaxMode.OFF);
                CoreUtils.SetKeyword(material, "_ParallaxMode_Parallax", ParallaxModeType == ParallaxMode.Parallax);
                CoreUtils.SetKeyword(material, "_ParallaxMode_Steep_Parallax", ParallaxModeType == ParallaxMode.Steep_Parallax);
                CoreUtils.SetKeyword(material, "_ParallaxMode_POM", ParallaxModeType == ParallaxMode.POM);
            }
